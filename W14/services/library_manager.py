    ...
    def ensure(self) -> None:
        ...
        while True:
            ...
            if answer.lower() == 'y':
                ...
                # 직접 설치할 수 있도록 명령어를 안내하고 종료한다.
                Utils.print_log('종료', '라이브러리 없이는 실행할 수 없습니다.')
                Utils.print_log('안내', '아래 명령어로 직접 설치한 뒤 다시 실행해 주세요.')
                print('  pip install -r ' + self.requirements_file)
                sys.exit(0)
            else:
